    ...
    <section>
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap md:gap-0">
            {services.map((service) => (
                <div key={service.id} className={`${service.id === 2 || service.id === 4 ? "bg-sYellow2" : "bg-sGreen2"} ${service.id === 2 || service.id === 3 ? "text-sYellow" : "text-sGreen"} w-full ${service.id < 3 ? "md:w-1/3" : "md:w-1/2"}`}>
